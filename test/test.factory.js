...
tape( 'the function returns a factory function (parameters)', function test( t ) {
	var createStream = factory( 20, 10, 7 );
	t.strictEqual( typeof createStream, 'function', 'returns expected value' );
	t.end();
});
...
tape( 'the function throws an error if provided a population size which is not a nonnegative integer', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( value, 10, 5 );
		};
	}
});

tape( 'the function throws an error if provided a population size which is not a nonnegative integer (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( value, 10, 5 );
			createStream();
		};
	}
});
...
tape( 'the function throws an error if provided a sub-population size which is not a nonnegative integer', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( 20, value, 5 );
		};
	}
});

tape( 'the function throws an error if provided a sub-population size which is not a nonnegative integer (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 20, value, 5 );
			createStream();
		};
	}
});
...
tape( 'the function throws an error if the number of draws is not a nonnegative integer', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( 20, 10, value );
		};
	}
});

tape( 'the function throws an error if the number of draws is not a nonnegative integer (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 20, 10, value );
			createStream();
		};
	}
});
...
tape( 'the function throws an error if the number of draws exceeds the total population size', function test( t ) {
	...
	function badValue( arr ) {
		return function badValue() {
			var createStream = factory();
			createStream( arr[0], arr[1], arr[2] );
		};
	}
});

tape( 'the function throws an error if the number of draws exceeds the total population size (parameters)', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if the subpopulation size exceeds the total population size (parameters)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if provided an options argument which is not an object (parameters)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 20, 10, 7, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 20, 10, 7 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
